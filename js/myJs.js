const textConfig = {
  ...
  text9: "Năm mới 2023 chúc Chutichacademy mãi keo và bạn Chi Ngờ năm mới gặp nhiều may mắn học tập hanh thông ko bị xì chét :)) 🤗 🤗 🤩 🤩", // mỗi bạn một câu chúc riêng đừng lộn
...
$(document).ready(function () {
  ...
  function firstQuestion() {
    ...
    Swal.fire({
      ...
      imageUrl: "img/ChiNg.jpg",    //ảnh pop up đầu
      imageWidth: 320,
      imageHeight: 400,
